...
<p>This site uses <code>localStorage</code> to store your Personalize configuration profiles.</p>
<p>It does not use that data on anything beyond the scope of that configuration.</p>
<br />
<p>This site does not use any kind of tracking.</p>
